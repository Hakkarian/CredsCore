...
class GraphBuilder:
    RELATION_TYPES = ["income_similarity", "age_proximity", "credit_profile_similarity"]
    ...
    def build_graph(self, df: pd.DataFrame, target_col: str = "SeriousDlqin2yrs") -> HeteroData:
